...
public class ClassStatementAnalizer extends CompoundAnalizer{
    ...
    public ClassStatementAnalizer(List<Table<Variable>> variableTables, List<Table<Function>> functionTables, List<Table<Variable>> retiredVariableTables, List<Table<Function>> retiredFunctionTables) {
